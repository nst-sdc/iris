...
export default function AboutUs() {
  const founders = [
    {
      name: 'xyz',
      role: 'Founder',
      quote: 'Engineering ideas into impact with robotics and AI.',
      image: '/membersimg/image.png',
      linkedin: 'https://linkedin.com/in/abhimanraj',
    },
    {
      name: 'xyz',
      role: 'Founder',
  ...
  const stats = [
    ...
    { icon: <Rocket className="w-6 h-6 text-purple-400" />, label: 'Projects Built', value: '15+' },
    { icon: <Lightbulb className="w-6 h-6 text-yellow-400" />, label: 'Innovations Patented', value: '0' },
    { icon: <Award className="w-6 h-6 text-green-400" />, label: 'National Awards', value: '5' },
  ]
...
const photos = [
  ...
  return (
    ...
    <div className="min-h-screen bg-black text-zinc-100 px-6 md:px-16 py-30 font-inter scroll-smooth">
    <Navbar />
      {/* Hero Section of Aboutus */}
      <section className="text-center max-w-3xl mx-auto mb-24">
        <h1 className="text-5xl md:text-6xl font-bold bg-linear-to-r from-blue-400 via-purple-400 to-pink-500 bg-clip-text text-transparent">
        ...
        <div className="w-32 h-[2px] mx-auto mt-6 bg-linear-to-r from-blue-500 via-purple-500 to-pink-500 rounded-full animate-pulse" />
      </section>
